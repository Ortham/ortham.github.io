...
I've gone into my reasons for choosing Material Design in my post on [redesigning LOOT's website]({% post_url 2014-12-16-loot-site-redesigned %}), where I also touched on a few problems I'd encountered using Polymer to implement it. I’ll go into the additional problems I experienced using it in LOOT itself, but first a bit about how Material Design prompted some changes.
